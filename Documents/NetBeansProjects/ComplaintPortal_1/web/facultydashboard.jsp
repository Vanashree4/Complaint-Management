    ...
    <body>
        ...
        <br>
                    ...
                    <table class="center" border="0">
                        ...
                        <tr>
                            <td>Ur Auto generated faculty id is <%=facultyid%>. Kindly use it for further operations.</td>
                        </tr>
                    </table>
       <div class="new">
       
        <a href="View.jsp" class="button">view complain</a>
           
               <a href="EndSession" class="button">Log-Out</a>
