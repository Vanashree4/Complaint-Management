...
div.new{
    ...
    <body>
        ...
        <tr>
                    <td>Complain id </td><td><input type="text" name="compid" /></td>
                </tr>
                <tr>
                    <td><input type="submit" class="button" value="Delete Complain"/><td><input type="reset" class="button" value="Reset"/></td>
                </tr>
